...
class AppColors {
  ...
  static const Color blue = Color(0xFF0E5FD9);
  ...
  static const Color red = Color(0xfff10808);
  static const Color black = Color(0xff262626);
  static const Color backgroundColor = Color(0xfff0f1f1);
  static const Color green2 = Color(0xff068d2c);
